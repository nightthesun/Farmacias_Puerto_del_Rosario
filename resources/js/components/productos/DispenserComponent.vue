                    ...
                    <table class="table table-bordered table-striped table-sm table-responsive">
                        ...
                        <tbody>
                            <tr v-for="dispenser in arrayDispenser" :key="dispenser.id">
                                <td class="col-md-1">
                                    <div  class="d-flex justify-content-start">
                                        <div  v-if="puedeEditar==1">
                                            <button type="button" class="btn btn-warning btn-sm" @click="abrirModal('actualizar',dispenser)" style="margin-right: 5px;">
                                        ...
                                        <div v-if="puedeActivar==1">
                                            <button v-if="dispenser.activo==1" type="button" class="btn btn-danger btn-sm" @click="eliminarDispenser(dispenser.id)" style="margin-right: 5px;">
                                        <i class="icon-trash"></i>
                                    </button>
                                    <button v-else type="button" class="btn btn-info btn-sm" @click="activarDispenser(dispenser.id)" style="margin-right: 5px;">
                                        <i class="icon-check"></i>
                                    </button>
                                        </div>
                                        <div v-else>
                                            <button v-if="dispenser.activo==1" type="button" class="btn btn-light btn-sm" style="margin-right: 5px;">
                                        <i class="icon-trash"></i>
                                    </button>
                                ...
                                <td v-text="dispenser.nombre" class="col-md-10"></td>
                                <td class="col-md-1">
