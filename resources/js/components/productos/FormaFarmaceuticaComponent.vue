                                ...
                                <td  class="col-md-1">
                                    <div  class="d-flex justify-content-start">
                                        <div  v-if="puedeEditar==1">
                                            <button type="button" class="btn btn-warning btn-sm" @click="abrirModal('actualizar',formafarm)" style="margin-right: 5px;">
                                        ...
                                        <div v-if="puedeActivar==1">
                                            <button v-if="formafarm.activo==1" type="button" class="btn btn-danger btn-sm" @click="eliminarFormaFarm(formafarm.id)" style="margin-right: 5px;">
                                        <i class="icon-trash"></i>
                                    </button>
                                    <button v-else type="button" class="btn btn-info btn-sm" @click="activarFormaFarm(formafarm.id)" style="margin-right: 5px;">
                                        <i class="icon-check"></i>
                                    </button>
                                        </div>

                                        <div v-else>
                                            <button v-if="formafarm.activo==1" type="button" class="btn btn-light btn-sm"  style="margin-right: 5px;">
                                        <i class="icon-trash"></i>
                                    </button>
                    ...
                    <div class="modal-footer">
                        ...
                        <div  class="d-flex justify-content-start">
                            <div  v-if="isSubmitting==false">
                                ...
                                <button type="button" v-if="tipoAccion == 2" class="btn btn-primary" @click="actualizarFormaFarm()" :disabled="!sicompleto">Actualizar</button>
                            </div>
                            <div v-else>
