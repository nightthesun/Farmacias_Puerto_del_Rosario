            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button
                        ...
                        @click="abrirModal('registrar');listarOperacionAuto();"
...
export default {
    ...
    methods: {
        ...
        listarOperacionAuto() {
        let me = this;           
        var url = "/auto-proceso/listarOperacionAuto";
            axios.get(url)
        ...
        listarTablaConfig() {
        let me = this;           
        var url = "/auto-proceso/listarTablaConfig";
            axios.get(url)
                .then(function (response) {
                   ...
                   if (respuesta_tras==null || respuesta_compras==null) {
                    ...
                    Swal.fire("Error nivel 1!","No se encontro las tablas","error",);  
                        ...
                        if (respuesta_tras.activo_traspaso==0) {
                            me.activador_nivel_1=1;

                            Swal.fire("Error nivel 2!","No esta activo la acción de auto traspasos","error",);         
                        } else {
                            me.activador_nivel_1=1;
                            if (respuesta_compras.activo_c_r_1==0) {
                                Swal.fire("Error nivel 3!","No esta activo en operaciones de activación modulo configuración sucursal / reloj","error",);  
                            } else {
                                me.activador_nivel_1=0;                                                           
                            }
                        }  
                   }                                                   
                })
