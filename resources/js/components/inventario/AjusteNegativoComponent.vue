                                    ...
                                    <div class="col-md-7 input-group mb-3" v-if="tipoAccion == 1" hidden>
                                        <select v-model="ProductoLineaIngresoSeleccionado" 
                                            ...
                                            <option
                                                ...
                                                "
                                                v-text="
                                                    'Cod: ' +ProductoLineaIngreso.codigo_producto+'  '+
                            ...
                            <div v-else>
                                ...
                                <button type="button" class="btn btn-warning" style="color: white;" @click="validarQuitar()">Quitar</button>
                                    ...
                                    <input
                                        ...
                                        hidden
                                    />
                                    <input type="text" v-if="tipoAccion == 1" v-model="fecha" hidden />
                                    <input
                                        type="text" v-if="tipoAccion == 1"
                                        v-model="id_sucursal"
                                        hidden
                                    ...
                                    <input
                                        ...
                                        hidden
                                    />
                                    <input type="text" v-if="tipoAccion == 2" disabled v-model="fecha" hidden />
                                    <input
                                        type="text" v-if="tipoAccion == 2" disabled
                                        v-model="id_sucursal"
                                        hidden
...
me.isSubmitting = true; // Deshabilita el botón
        ...
        actualizarAjusteNegativo() {
            ...
            let suma = me.cantidadProductoLineaIngreso - me.cantidadS;
            axios
                .put("/ajustes-negativo/actualizar", {
        ...
        listarAjusteNegativos(page) {
            ...
            var url ="/ajustes-negativo?page="+page+"&buscar=" +me.buscar+"&buscarAlmTdn=" +me.sucursalSeleccionada+"&ini="+me.startDate+"&fini="+me.endDate;
            axios.get(url)
                .then(function (response) {
                    var respuesta = response.data;
            ...
            swalWithBootstrapButtons
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        axios
                            .put("/ajustes-negativo/desactivar", {
