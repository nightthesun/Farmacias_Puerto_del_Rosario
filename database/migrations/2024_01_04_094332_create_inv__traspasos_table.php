...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('inv__traspasos', function (Blueprint $table) {
            ...
            $table->integer('cantidad_stock_ingreso')->comment('Cantidad de productos que esta ingresando a la tienda y ttambien el stock actual de ese producto');
           ...
           //traspaso---
            $table->unsignedBigInteger("id_origen")->unsigned()->comment("id_ingreso del almacen o tienda origen");	           
            $table->unsignedBigInteger("id_destino")->unsigned()->comment("id_ingreso del almacen o tienda destino");	            
            $table->unsignedBigInteger("id_ingreso")->unsigned()->comment("id del ingreso de almacen o tienda");
            ...
            $table->timestamps();
            $table->smallInteger('user_id')->nullable()->comment('Registra según la acción'); 
            $table->string('name_des')->nullable();
            $table->string('name_ori')->nullable();
            $table->smallInteger('correlativo')->nullable();
            $table->integer('cantidad_old')->nullable()->comment('Cantidad antes de la modificación');
