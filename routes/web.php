...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::put('/qr_simple/editarBanco', [AdmQrSimpleController::class, 'edit']);  
   ...
   //------------------------------lista de productos 
    ...
    Route::get('/siat_eventos/listarModalSucuralSiatPunto', [SiatEventoController::class, 'getModalSucuralSiatPunto']); 
    ...
    Route::put('/siat_eventos/cambioEstadoEvento', [SiatEventoController::class, 'cambio_estado_evento']);
